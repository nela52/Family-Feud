...
public class FamilyFued extends Canvas implements Runnable
{
	...
	public static int fastMoneyRoundNum = 1;

	public static int fastMoneyRound1Total = 0;
	public static int fastMoneyTotal = 0;
	...
	private static InputStream input = FamilyFued.class.getResourceAsStream("/Family Fued.txt");
	...
	private void render()
	{
		...
		} else
		{
			...
			{
				g.drawImage(intro, 0, 0, this);
				drawCenteredString(g, winner.getName() + " won the game!", new Rectangle(0, 0, 1920, 1080), font.deriveFont(84F));
			...
			{
				g.drawImage(intro, 0, 0, this);
				drawCenteredString(g, winner.getName() + " gets $" + moneyWon + "!", new Rectangle(0, 0, 1920, 1080), font.deriveFont(84F));
			} else
			{
	...
	public static ArrayList<String> loadTextFile(InputStream is) throws IOException
	{
	...
	public static void loadQuestions()
	{
		try
		{
			for (String line : loadTextFile(input))
			{
				lines.add(line);
			}
		} catch (IOException e)
	...
	public static Font setFontSize(float size)
	{
